...
class _MainScreenState extends State<MainScreen> {
  ...
  Widget build(BuildContext context) {
    // List of tab screens. The Cart tab (index 1) is not shown here - tapping
    // it pushes the CartView route instead, so it keeps a normal back button
    // and can also be reached from the Detail screen's cart icon.
